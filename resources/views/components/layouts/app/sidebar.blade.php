...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <a href="{{ route('lists.index') }}" class="me-5 flex items-center space-x-2 rtl:space-x-reverse" wire:navigate>
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group class="grid">
                    <flux:navlist.item icon="bookmark" :href="route('lists.index')" :current="request()->routeIs('lists.*')" wire:navigate>{{ __('My Lists') }}</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
